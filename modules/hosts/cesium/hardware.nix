# cesium hardware — disks (ZFS), boot modules, Chromebook audio (cros UCM),
# zram, timezone. Copied from nix/hosts/cesium/hardware.nix and wrapped as a
# contribution to the cesium host aspect (import-tree loads every modules/**.nix
# as a flake-parts module, so a raw NixOS module can't live here directly).
_: {
