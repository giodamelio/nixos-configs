# zellij — zellij multiplexer with custom plugins, a fuzzy session picker (zz),
# and a hand-written KDL config. Converted from nix/modules/home/zellij.nix.
...
{inputs, ...}: {
  den.aspects.zellij.homeManager = {
    ...
    zz = inputs.self.lib.writeNushellApplication pkgs {
      name = "zz";
