# waybar — status bar behind the gio.waybar options (module layout, per-monitor
# bars, network graphs, claude-usage, power menu). Converted from
# nix/modules/home/waybar/. flake.packages.${system} -> perSystem.self.
_: {
