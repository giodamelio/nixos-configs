# hyprland — alternate Wayland compositor with cadmium's monitor layout baked
# in. Converted from nix/modules/home/hyprland.nix.
_: {
  den.aspects.hyprland.homeManager = {pkgs, ...}: {
