# zfs-backup — sanoid autosnapshots (and the dormant syncoid sync-to-gallium
# plumbing) behind the gio.zfs_backup options. Converted from
# nix/modules/nixos/zfs-backup.nix.
_: {
  den.aspects.zfs-backup.nixos = {
    lib,
    config,
    pkgs,
    ...
