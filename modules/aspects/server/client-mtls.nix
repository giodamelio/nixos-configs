# client-mtls — automatic renewal of a host's mTLS client certificate against
# the step-ca on carbon. Converted from nix/modules/nixos/client-mtls.nix.
_: {
  den.aspects.client-mtls.nixos = {pkgs, ...}: {
