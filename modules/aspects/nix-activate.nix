# nix-activate — the nix-activate-config helper script. Converted from
# nix/modules/home/nix-activate.nix (Home-Manager only).
_: {
  den.aspects.nix-activate.homeManager = {
    config,
    lib,
    pkgs,
    ...
